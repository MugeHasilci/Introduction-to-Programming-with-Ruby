=begin
Write a program that prints 'Makers Academy is the best!' repeatedly until a
...
is a topic with a fair number of edge conditions that are beyond the scope of this
exercise.
=end
...
loop do
  ...
  if lines <= 2
    ...
    lines.times do
      puts "Makers academy is the best"
    end
    break
  end
end
